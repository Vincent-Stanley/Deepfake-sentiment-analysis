...
def train() :
    ...
    cnb = ComplementNB()
    cnb_grid_search=GridSearchCV( #melakukan grid search dengan negatice log loss sebagai nilai evaluasi model dan stratefied k-fold sebagai pemisahan data dari cross validarion
        estimator=cnb,
        param_grid=cnb_grid,
    ...
    tuned_grid_model = cnb_grid_search.fit(train_texts, train_labels)
